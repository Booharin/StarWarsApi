...
class SpecieController: UITableViewController, NSFetchedResultsControllerDelegate, UISearchBarDelegate {
    
    private lazy var resultsController: NSFetchedResultsController<Specie>? = {
        var resultController: NSFetchedResultsController<Specie>?
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let descriptionController = segue.destination as? SpecieDescriptionController {
