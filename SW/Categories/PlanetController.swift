...
class PlanetController: UITableViewController, NSFetchedResultsControllerDelegate, UISearchBarDelegate {
    
    private lazy var resultsController: NSFetchedResultsController<Planet>? = {
        var resultController: NSFetchedResultsController<Planet>?
    ...
    override func viewDidLoad() {
        ...
        DataRepository.shared.fetchAll(for: .planets)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let descriptionController = segue.destination as? PlanetDescriptionController {
