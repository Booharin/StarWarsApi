...
class StarshipsController: UITableViewController, NSFetchedResultsControllerDelegate, UISearchBarDelegate {
    
    private lazy var resultsController: NSFetchedResultsController<StarShip>? = {
        var resultController: NSFetchedResultsController<StarShip>?
    ...
    override func viewDidLoad() {
        ...
        DataRepository.shared.fetchAll(for: .starships)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if let descriptionController = segue.destination as? StarshipDescriptionController {
